        ...
        if (dbkjs.options.organisation.support) {
            ...
            $('#foutknop').click(function () {
                ...
                var adres_input = $('<div class="form-group"><label class="col-sm-2 control-label" for="address">' +
                        ...
                        '</label><div class="col-sm-10"><input id="address" name="address" type="text" class="form-control" placeholder="' +
                ...
                var user_input = $('<div class="form-group"><label class="col-sm-2 control-label" for="name">' +
                        i18n.t('email.name') +
                        ' *</label><div class="col-sm-10"><input id="name" name="name" type="text" class="form-control required" placeholder="' +
                        i18n.t('email.name') + '"></div></div>');
                p.append(user_input);
                var mail_input = $('<div class="form-group"><label class="col-sm-2 control-label" for="email">' +
                        i18n.t('email.email') +
                        ' *</label><div class="col-sm-10"><input id="email" name="email" type="email" class="form-control required" placeholder="' +
                        i18n.t('email.email') + '"></div></div>');
                p.append(mail_input);
                var tel_input = $('<div class="form-group"><label class="col-sm-2 control-label" for="phone">' +
                        i18n.t('email.phone') +
                        '</label><div class="col-sm-10"><input id="phone" name="phone" type="tel" class="form-control" placeholder="' +
                ...
                var remarks_input = $('<div class="form-group"><label class="col-sm-2 control-label" for="remarks">' +
                        ...
                        ' *</label><div class="col-sm-10"><textarea id="remarks" name="remarks" class="form-control required" placeholder="' +
