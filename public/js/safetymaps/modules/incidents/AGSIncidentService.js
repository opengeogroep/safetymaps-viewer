...
AGSIncidentService.prototype.getCurrentIncidents = function() {
    ...
    me.doAGSAjax({
        ...
        data: {
            ...
            outFields: "INCIDENT_ID,T_X_COORD_LOC,T_Y_COORD_LOC,DTG_START_INCIDENT,PRIORITEIT_INCIDENT_BRANDWEER,NAAM_LOCATIE1,HUIS_PAAL_NR,HUIS_NR_TOEV,HUISLETTER,NAAM_LOCATIE2,TYPE_LOCATIE2,PLAATS_NAAM_NEN,BRW_MELDING_CL_ID"
        },
        cache: false
    })
    .fail(function(e) {
